...
endpointsToSkip = [
  ...
  '/api/v1/harvest/plans > Register a new harvest > 200 > application/json',
  '/api/v1/harvest/plans/{plan_id} > Get single harvest plan > 200 > application/json',
  '/api/v1/harvest/info/{id}/{run_id} > Information about a specific previous harvest run > 200 > application/json',
  '/api/v1/harvest/runs > Runs a harvest > 200 > application/json',
  '/api/v1/harvest/runs > List previous runs for a harvest id > 200 > application/json',
...
endpointsRequiringAuth = [
  ...
  '/api/v1/{property}/{uuid} > Replace a property > 200 > application/json',
  '/api/v1/{property}/{uuid} > Update a property > 200 > application/json',
  '/api/v1/harvest/plans > Lists harvest identifiers > 200 > application/json',
  '/api/v1/harvest/plans > Register a new harvest > 200 > application/json',
  '/api/v1/harvest/plans/{plan_id} > Get single harvest plan > 200 > application/json',
  '/api/v1/harvest/runs > Runs a harvest > 200 > application/json',
  '/api/v1/harvest/runs > List previous runs for a harvest id > 200 > application/json',
