context('API', () => {
    ...
    context('GET requests', () => {
        it('GET a single dataset', () => {
            cy.request("http://pqdc/api/v1/dataset/" + json1.identifier).then((response) => {
        ...
        it('GET a non-existent dataset', () => {
            cy.request({
                url: "http://pqdc/api/v1/dataset/" + jsonShouldNotExist.identifier,
        ...
        it('GET all datasets', () => {
            cy.request("http://pqdc/api/v1/dataset").then((response) => {
                expect(response.status).eql(200)
    ...
    context('POST requests', () => {
        ...
        it('POST creates a dataset', () => {
            ...
            cy.request("http://pqdc/api/v1/dataset/" + jsonPost.identifier).then((response) => {
                expect(response.status).eql(200)
    ...
    context('PUT requests', () => {
        ...
        it('PUT fails to modify the identifier', () => {
            cy.request({
                method: 'PUT',
                url: 'http://pqdc/api/v1/dataset/' + json1.identifier,
                auth: user_credentials,
                body: jsonShouldNotExist,
                failOnStatusCode: false
            }).then((response) => {
        ...
        it('PUT creates a dataset, if non-existent', () => {
            cy.request({
                method: 'PUT',
                url: 'http://pqdc/api/v1/dataset/' + jsonPut.identifier,
                auth: user_credentials,
                body: jsonPut
            }).then((response) => {
                expect(response.status).eql(201)
            ...
            cy.request('http://pqdc/api/v1/dataset/' + jsonPut.identifier).then((response) => {
                expect(response.status).eql(200)
    ...
    context('PATCH requests', () => {
        ...
        it('PATCH fails to modify the identifier', () => {
            cy.request({
                method: 'PATCH',
                url: 'http://pqdc/api/v1/dataset/' + json2.identifier,
                auth: user_credentials,
                body: {
        ...
        it('PATCH - empty payload', () => {
            ...
            // Verify data is as expected.
            cy.request('http://pqdc/api/v1/dataset/' + json2.identifier).then((response) => {
                expect(response.status).eql(200)
    ...
    context('DELETE requests', () => {
        it('DELETE fails without basic authentication', () => {
            cy.request({
                method: 'DELETE',
                url: 'http://pqdc/api/v1/dataset/' + jsonPost.identifier,
                failOnStatusCode: false
            }).then((response) => {
                expect(response.status).eql(401)
            })
